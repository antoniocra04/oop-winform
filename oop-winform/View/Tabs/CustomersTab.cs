...
namespace oop_winform.View.Tabs
{
    public partial class CustomersTab : UserControl
    {
        ...
        private void FullNameTextBox_Leave(object sender, EventArgs e)
        {
            if (CustomersListBox.SelectedIndex >= 0)
            {
                if (FullNameTextBox.BackColor == Constants.CorrectColor)
                {   
        ...
        private void AddressTextBox_Leave(object sender, EventArgs e)
        {
            if (CustomersListBox.SelectedIndex >= 0)
            {
                if (AddressTextBox.BackColor == Constants.CorrectColor)
                {
        ...
        private void SplitedTableLayoutPanel_Paint(object sender, PaintEventArgs e)
        {
